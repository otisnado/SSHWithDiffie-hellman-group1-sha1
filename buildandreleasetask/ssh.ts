...
async function run() {
    ...
    try {
        ...
        const kexAlgorithm: string = tl.getInput('kexAlgorithm', true);
        ...
        console.log(tl.loc('SettingUpSshConnection', sshConfig.username, sshConfig.host, sshConfig.port, sshConfig.algorithms.kex));
        try {
...
function getReadyTimeoutVariable(): number {
    const readyTimeoutString: string = "20000";
